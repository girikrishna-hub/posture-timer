 ...
 * v3: adds a fetch interceptor to log every network request Clerk makes,
 * plus window.onerror and unhandledrejection capture.
 *
...
const INTERESTING = ["__clerk", "clerk.dev", "clerk.io", "clerk.com", "jsdelivr", "jsdelivr"];
